...
from homeassistant.components.media_player import (
    ...
    MEDIA_TYPE_MUSIC, SUPPORT_PLAY_MEDIA, MEDIA_PLAYER_SCHEMA, DOMAIN,
...
PLATFORM_SCHEMA = PLATFORM_SCHEMA.extend({
    ...
    vol.Required(CONF_LAST_RADIO_STATION): cv.string,
...
#    asyncio.ensure_future(pioneer.readdata())
    ...
    async_add_entities([pioneer], update_before_add=True)
...
class PioneerDevice(MediaPlayerDevice):
    ...
    def __init__(self, name, ip, port, disabled_sources, last_radio_station, radio_stations):
        _LOGGER.debug("Init")
        self.port = port
        self.ip = ip
    ...
    def select_speaker(self, speaker):
        ...
        if speaker == "A":
            ...
            command = "3"
        self.telnet_command(command+"SPK")
